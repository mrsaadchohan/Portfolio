   ...
   <section className='lg:py-16'>
    ...
    <motion.div
        ...
        <h1 className='text-white mb-4 text-2xl md:text-3xl lg:text-5xl lg:leading-normal font-extrabold'>
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Hello, I am
            <br />
            <span className=''>Saad Chohan</span></span> 
        <br />
        <TypeAnimation
              sequence={[
                "Front End Developer",
        ...
        Dynamic and responsive web applications with modern technologies.
         ...
         <div>
            ...
            <button className=''>
            <a href="/frontend.pdf" download className='px-6 py-3 w-full sm:w-fit rounded-full bg-transparent hover:bg-slate-800 mt-3 text-white border border-white inline-block text-center'>Download CV</a>
