...
function About() {
  return (
    <div id="About" className="flex flex-col md:flex-row gap-4 md:gap-8 mt-8 py-4 px-2 sm:py-8 sm:px-4 lg:py-12 lg:px-10 lg:items-center">
      {/* Left side */}
      <div className="flex justify-center md:justify-start lg:ml-16">
        <Image src="/about-image.png" alt="About" width={500} height={500} className="max-w-full h-auto" />
      </div>
      {/* Right side */}
      <div className="mt-4 md:mt-0 lg:ml-16 text-center md:text-left">
        <h1 className="text-white text-2xl md:text-3xl lg:text-4xl">About Me</h1>
